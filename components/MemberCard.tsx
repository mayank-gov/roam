    ...
    return (
        <Card className="h-full">
            ...
            {getDaysInfo()}
                ...
                <p className="text-sm text-gray-500 mt-1">Flextrack: {member.flextrackNumber}</p>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-900">{formatDate(member.startDate)}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500">End Date</p>
                        <p className="text-sm text-gray-900">{formatDate(member.endDate)}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500">Hiring Manager</p>
                        <p className="text-sm text-gray-900">{member.hiringManager || 'N/A'}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500">Duration</p>
                        <p className="text-sm text-gray-900">{getRemainingDuration()}</p>
                    </div>
                </div>
